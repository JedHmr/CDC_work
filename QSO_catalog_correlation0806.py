...
# %% 1" MATCH RADIUS correlation

# SkyCoord objects for tables (3XMM has associated deg units)
...
# catalog matching DR7 to 3XMM
max_sep = 1.0*u.arcsec  # search radius
...
sep_constraint1 = d2d_3XMM1 < max_sep
sep_constraint2 = d2d_3XMM2 < max_sep

# matches_DR#c & matches_DR#_3XMM are matched sources in DR# and 3XMM with sep
matches_DR7c = coords_DR7[sep_constraint1]
matches_DR12c = coords_DR12[sep_constraint2]
matches_DR7_3XMM = t_3XMM[idx_3XMM1[sep_constraint1]]
matches_DR12_3XMM = t_3XMM[idx_3XMM2[sep_constraint2]]

fig, axs = plt.subplots(2)
fig.suptitle('SDSS DR7,DR12 & 3XMM DR7 position correlations')
axs[0].set_title('SDSS DR7 - 3XMM DR7')
axs[1].set_xlabel('separation [arcsec]')
axs[1].set_title('SDSS DR12 - 3XMM DR7')
axs[0].hist(d2d_3XMM1.arcsec, histtype='step', range=(0, 2))
axs[1].hist(d2d_3XMM2.arcsec, histtype='step', range=(0, 2))
axs[0].hist(d2d_3XMM1[sep_constraint1].arcsec, histtype='step', range=(0, 2))
axs[1].hist(d2d_3XMM2[sep_constraint2].arcsec, histtype='step', range=(0, 2))
